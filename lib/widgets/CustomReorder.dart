...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class CustomReorder extends StatefulWidget {
  ...
  @override
  _CustomReorderState createState() => _CustomReorderState();
}
...
class _CustomReorderState extends State<CustomReorder> {
...
class _ReorderableListContentState extends State<_ReorderableListContent> with TickerProviderStateMixin<_ReorderableListContent> {
  ...
  static const Duration _reorderAnimationDuration = Duration(milliseconds: 100);
